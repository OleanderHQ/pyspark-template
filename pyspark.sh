...
PYSPARK_BIN="${PYSPARK_BIN:-pyspark}"
...
tmp_file="$(mktemp "/tmp/oleander-pyspark-conf.XXXXXX")"
...
exec "$PYSPARK_BIN" "${wrapper_args[@]}" "${catalog_args[@]}" "${user_args[@]}"
